...
const REG_FORMATS: RegFormat[] = [
  ...
  { country: 'East Germany', prefixes: ['DDR-S', 'DM-S'], suffixMin: 2, suffixMax: 2, suffixCharset: ALPHA, weight: 4 },
  ...
  { country: 'China', prefixes: ['B-'], suffixMin: 4, suffixMax: 4, suffixCharset: DIGITS, weight: 6.4 },
